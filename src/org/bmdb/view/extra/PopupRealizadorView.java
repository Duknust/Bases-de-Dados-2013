 ...
 * @author duarteduarte
 */
public class PopupRealizadorView extends javax.swing.JFrame {

    /**
     * Creates new form PopupFilme
     */
    public PopupRealizadorView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupRealizadorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupRealizadorView().setVisible(true);
            }
        });
    }
