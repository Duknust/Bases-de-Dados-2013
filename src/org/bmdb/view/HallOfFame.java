...
public class HallOfFame extends javax.swing.JDialog {
     ...
     */
    public HallOfFame(JFrame parent, Properties props) {
        super(parent);
        initComponents();
        ...
        try {
            ...
            double vencidos = 0.0;
            int rating = 0;
            List<Actor> halloffame = ms.getHallOfFame();
            if (halloffame.size() >= 1) {
                nomeado = halloffame.get(0).getPremiosNomeadoActor();
                vencidos = halloffame.get(0).getPremiosVencidosActor() + halloffame.get(0).getOscaresVencidos();
                rating = (int) ((vencidos / nomeado) * 100);
                jLabelNumber1Pic.setIcon(new ImageIcon("images/actores/" + halloffame.get(0).getImagem()));
                jLabelNumber1Desc.setText(halloffame.get(0).getNomeActor() + " (" + rating + "%)");
            }
            if (halloffame.size() >= 2) {
                nomeado = halloffame.get(1).getPremiosNomeadoActor();
                vencidos = halloffame.get(1).getPremiosVencidosActor() + halloffame.get(1).getOscaresVencidos();
                rating = (int) ((vencidos / nomeado) * 100);
                jLabelNumber2Pic.setIcon(new ImageIcon("images/actores/" + halloffame.get(1).getImagem()));
                jLabelNumber2Desc.setText(halloffame.get(1).getNomeActor() + " (" + rating + "%)");
            }
            if (halloffame.size() >= 3) {
                nomeado = halloffame.get(2).getPremiosNomeadoActor();
                vencidos = halloffame.get(2).getPremiosVencidosActor() + halloffame.get(2).getOscaresVencidos();
                rating = (int) ((vencidos / nomeado) * 100);
                jLabelNumber3Pic.setIcon(new ImageIcon("images/actores/" + halloffame.get(2).getImagem()));
                jLabelNumber3Desc.setText(halloffame.get(2).getNomeActor() + " (" + rating + "%)");
            }
            if (halloffame.size() >= 4) {
                nomeado = halloffame.get(3).getPremiosNomeadoActor();
                vencidos = halloffame.get(3).getPremiosVencidosActor() + halloffame.get(3).getOscaresVencidos();
                rating = (int) ((vencidos / nomeado) * 100);
                jLabelNumber4Pic.setIcon(new ImageIcon("images/actores/" + halloffame.get(3).getImagem()));
                jLabelNumber4Desc.setText(halloffame.get(3).getNomeActor() + " (" + rating + "%)");
            }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Formula de Calculo : ((premios_vencidos + oscares) / premios_nomeado) *100 ^ premios_nomeado<2*(premios_vencidos+oscares)        // destaque nos premios vencidos");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HallOfFame(null, null).setVisible(true);
            }
        });
    }
