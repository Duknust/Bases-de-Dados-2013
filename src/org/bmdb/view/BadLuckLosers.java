 ...
 * @author duarteduarte
 */
public class BadLuckLosers extends javax.swing.JDialog {
     ...
     */
    public BadLuckLosers(JFrame parent, Properties props) {
        super(parent);
        initComponents();
        ...
        try {
            ...
            double vencidos = 0.0;
            int rating = 0;
            List<Actor> badluckers = ms.getBadLuckLosers();
            if (badluckers.size() >= 1) {
                nomeado = badluckers.get(0).getPremiosNomeadoActor();
                vencidos = badluckers.get(0).getPremiosVencidosActor() + badluckers.get(0).getOscaresVencidos();
                rating = 100 - (int) ((vencidos / nomeado) * 100);
                jLabelNumber1Pic.setIcon(new ImageIcon("images/actores/" + badluckers.get(0).getImagem()));
                jLabelNumber1Desc.setText(badluckers.get(0).getNomeActor() + " (" + rating + "%)");
            }
            if (badluckers.size() >= 2) {
                nomeado = badluckers.get(1).getPremiosNomeadoActor();
                vencidos = badluckers.get(1).getPremiosVencidosActor() + badluckers.get(1).getOscaresVencidos();
                rating = 100 - (int) ((vencidos / nomeado) * 100);
                jLabelNumber2Pic.setIcon(new ImageIcon("images/actores/" + badluckers.get(1).getImagem()));
                jLabelNumber2Desc.setText(badluckers.get(1).getNomeActor() + " (" + rating + "%)");
            }
            if (badluckers.size() >= 3) {
                nomeado = badluckers.get(2).getPremiosNomeadoActor();
                vencidos = badluckers.get(2).getPremiosVencidosActor() + badluckers.get(2).getOscaresVencidos();
                rating = 100 - (int) ((vencidos / nomeado) * 100);
                jLabelNumber3Pic.setIcon(new ImageIcon("images/actores/" + badluckers.get(2).getImagem()));
                jLabelNumber3Desc.setText(badluckers.get(2).getNomeActor() + " (" + rating + "%)");
            }
            if (badluckers.size() >= 4) {
                nomeado = badluckers.get(3).getPremiosNomeadoActor();
                vencidos = badluckers.get(3).getPremiosVencidosActor() + badluckers.get(3).getOscaresVencidos();
                rating = 100 - (int) ((vencidos / nomeado) * 100);
                jLabelNumber4Pic.setIcon(new ImageIcon("images/actores/" + badluckers.get(3).getImagem()));
                jLabelNumber4Desc.setText(badluckers.get(3).getNomeActor() + " (" + rating + "%)");
            }
        } catch (BslConnectionBrokerUnavailableException ex) {
            Logger.getLogger(BadLuckLosers.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bad Luck Losers");
        ...
        jLabel3.setText("Formula de Calculo : ((premios vencidos + oscares) / premios nomeado) *100 ^premios_nomeado >(2*(premios_vencidos+oscares))");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BadLuckLosers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BadLuckLosers(null, null).setVisible(true);
            }
        });
    }
